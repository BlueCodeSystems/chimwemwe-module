...
public class ScheduleDaoTest extends ScheduleDao {
    ...
    public void testGetActiveFamilies() {
        ...
        List<String> activeFamilies = getActiveFamilies("FAMILY HOME VISIT", "Home visit");
    ...
    public void testGetActiveANCWomen() {
        ...
        List<String> activeANCWomen = getActiveANCWomen("ANC HOME VISIT", "Home visit");
    ...
    public void testGetActivePNCWomen() {
        ...
        List<String> activePNCWomen = getActivePNCWomen("PNC HOME VISIT", "Home visit");
    ...
    public void testGetActiveFPWomen() {
        ...
        List<String> activeFPWomen = getActiveFPWomen("FP HOME VISIT", "Home visit");
    ...
    public void testGetActiveChildren() {
        ...
        List<String> activeChildren = getActiveChildren("CHILD HOME VISIT", "Home visit");
    ...
    public void testGetActiveChildrenUnder5AndGirlsAge9to11() {
        ...
        List<String> activeChildrenFiveAndGirlsNineToEleven = getActiveChildrenUnder5AndGirlsAge9to11("CHILD HOME VISIT", "Home visit");
