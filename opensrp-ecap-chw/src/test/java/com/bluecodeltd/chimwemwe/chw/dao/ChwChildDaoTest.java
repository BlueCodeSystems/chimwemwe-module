...
public class ChwChildDaoTest extends ChwChildDao {
    ...
    public void testGetChildGender() {
        ...
        String gender = getChildGender("12345");
    ...
    public void testGetChildFamilyName() {
        ...
        String familyName = getChildFamilyName("12345");
    ...
    public void testHasDueVaccines() {
        ...
        Boolean dueVaccines = hasDueVaccines("12345");
    ...
    public void testHasDueAlerts() {
        ...
        Boolean dueVaccines = hasDueAlerts("12345");
    ...
    public void testHasActiveSchedule() {
        ...
        Boolean dueVaccines = hasActiveSchedule("12345");
    ...
    public void testGetRegisteredCertificateNumbers() {
        ...
        List<String> certificateNumbers = getRegisteredCertificateNumbers();
