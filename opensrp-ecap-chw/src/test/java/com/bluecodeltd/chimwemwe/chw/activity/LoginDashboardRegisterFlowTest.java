...
import com.bluecodeltd.chimwemwe.chw.BaseActivityTestSetUp;
...
public class LoginDashboardRegisterFlowTest extends BaseActivityTestSetUp<Activity> {
    ...
    public void testFamilyRegisterActivityReceivesStartRegistrationAction() {
        ...
        intent.putExtra(
                com.bluecodeltd.chimwemwe.chw.util.Constants.ACTIVITY_PAYLOAD.ACTION,
        ...
        assertEquals(
                org.smartregister.chw.core.utils.CoreConstants.ACTION.START_REGISTRATION,
                activity.getIntent().getStringExtra(com.bluecodeltd.chimwemwe.chw.util.Constants.ACTIVITY_PAYLOAD.ACTION)
        );
    }
}
