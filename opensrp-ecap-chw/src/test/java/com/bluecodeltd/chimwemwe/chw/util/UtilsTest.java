...
import static com.bluecodeltd.chimwemwe.chw.util.Utils.formatDateForVisual;
import static com.bluecodeltd.chimwemwe.chw.util.Utils.getClientName;
import static com.bluecodeltd.chimwemwe.chw.util.Utils.getFormattedDateFromTimeStamp;
...
public class UtilsTest extends AutoCloseKoinTest {
    ...
    public void testGetWFHZScore() {
        double score = com.bluecodeltd.chimwemwe.chw.util.Utils.getWFHZScore("Male", "70", "70");
        Assert.assertNotEquals(100.0, score, 0.0);
    }

    @Test
    public void testToCSV() {
        String csv = com.bluecodeltd.chimwemwe.chw.util.Utils.toCSV(Arrays.asList("foo", "bar", "baz"));
