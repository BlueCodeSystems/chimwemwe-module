...
public class FamilyDaoTest extends FamilyDao {
    ...
    public void testGetFamilyServiceScheduleReturnsVisits() {
        ...
        Map<String, Integer> visits = getFamilyServiceSchedule("12345");
    ...
    public void testGetFamilyServiceScheduleWithChildrenOnlyUnderTwoReturnsVisits() {
        ...
        Map<String, Integer> visits = getFamilyServiceScheduleWithChildrenOnlyUnderTwo("12345");
    ...
    public void testGetMemberDueStatus() {
        ...
        String visitState = getMemberDueStatus("12345");
    ...
    public void testGetMemberDueStatusForUnderTwoChildren() {
        ...
        String visitState = getMemberDueStatusForUnderTwoChildren("12345");
    ...
    public void testGetFamilyCreateDateReturnsEmptyString() {
        ...
        long eventDate = getFamilyCreateDate("12345");
    ...
    public void testFamilyHasChildUnderFiveTrue() {
        ...
        Boolean familyHasChildUnderFive = familyHasChildUnderFive("12345");
    ...
    public void testIsFamily() {
        ...
        Boolean isFamily = isFamily("12345");
    ...
    public void getFamilyAlertStatusReturnsCorrectStatus() {
        ...
        AlertStatus status = getFamilyAlertStatus("entity-id-123");
    ...
    public void testGetFamilyDetail() {
        ...
        FamilyDetailsModel familyDetailsModel = getFamilyDetail("12345");
    ...
    public void testGetFamilyDetailReturnsNull() {
        ...
        FamilyDetailsModel familyDetail = getFamilyDetail("12345");
