...
public class ChwPNCDaoTest extends ChwPNCDao {
    ...
    public void testGetLastHealthFacilityVisitSummary() {
        ...
        @Nullable PNCHealthFacilityVisitSummary chwPNCDao = getLastHealthFacilityVisitSummary("12345", database);
    ...
    public void testGetLastPNCHealthFacilityVisits() {
        ...
        List<VisitDetail> visitDetail = getLastPNCHealthFacilityVisits("12345");
