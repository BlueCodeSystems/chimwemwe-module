            ...
            switch (viewId) {
                ...
                case org.smartregister.chw.core.R.id.refer_to_facility_layout:
                    if (BuildConfig.USE_UNIFIED_REFERRAL_APPROACH) {
                        com.bluecodeltd.chimwemwe.chw.util.Utils.launchClientReferralActivity(activity,  com.bluecodeltd.chimwemwe.chw.util.Utils.getCommonReferralTypes(activity), baseEntityId);
                    } else {
