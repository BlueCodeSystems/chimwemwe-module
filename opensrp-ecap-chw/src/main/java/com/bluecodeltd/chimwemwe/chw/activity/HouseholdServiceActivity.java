...
import com.bluecodeltd.chimwemwe.chw.adapter.HouseholdServiceAdapter;
...
public class HouseholdServiceActivity extends AppCompatActivity {
    ...
    private com.bluecodeltd.chimwemwe.chw.databinding.ActivityHouseholdServiceBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.bluecodeltd.chimwemwe.chw.databinding.ActivityHouseholdServiceBinding.inflate(getLayoutInflater());
                    ...
                    Threading.main(() -> {
                        ...
                        if (finalCasePlanCount == 0){
                            ...
                            try {
                                ...
                                applyPregnantBreastfeedingVisibility(indexRegisterForm, finalHouseBg.getCaregiver_sex());
