...
public class PMTCTMotherOverviewFragment extends Fragment {
    ...
    private com.bluecodeltd.chimwemwe.chw.databinding.FragmentPmtctMotherOverviewBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = com.bluecodeltd.chimwemwe.chw.databinding.FragmentPmtctMotherOverviewBinding.inflate(inflater, container, false);
