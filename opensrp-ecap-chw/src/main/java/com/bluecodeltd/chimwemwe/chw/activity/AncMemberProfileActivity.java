...
import com.bluecodeltd.chimwemwe.chw.custom_view.AncFloatingMenu;
import com.bluecodeltd.chimwemwe.chw.dataloader.AncMemberDataLoader;
import com.bluecodeltd.chimwemwe.chw.dataloader.FamilyMemberDataLoader;
import com.bluecodeltd.chimwemwe.chw.interactor.AncMemberProfileInteractor;
...
import com.bluecodeltd.chimwemwe.chw.presenter.AncMemberProfilePresenter;
...
import static com.bluecodeltd.chimwemwe.chw.util.NotificationsUtil.handleNotificationRowClick;
import static com.bluecodeltd.chimwemwe.chw.util.NotificationsUtil.handleReceivedNotifications;
...
public class AncMemberProfileActivity extends CoreAncMemberProfileActivity implements AncMemberProfileContract.View {
    ...
    private void addAncReferralTypes() {
        referralTypeModels.add(new ReferralTypeModel(getString(R.string.anc_danger_signs),
                BuildConfig.USE_UNIFIED_REFERRAL_APPROACH ? com.bluecodeltd.chimwemwe.chw.util.Constants.JSON_FORM.getAncUnifiedReferralForm() : com.bluecodeltd.chimwemwe.chw.util.Constants.JSON_FORM.getAncReferralForm(), CoreConstants.TASKS_FOCUS.ANC_DANGER_SIGNS));

        if (BuildConfig.USE_UNIFIED_REFERRAL_APPROACH) {
            referralTypeModels.add(new ReferralTypeModel(getString(R.string.hiv_referral),
                    com.bluecodeltd.chimwemwe.chw.util.Constants.JSON_FORM.getHivReferralForm(), CoreConstants.TASKS_FOCUS.SUSPECTED_HIV));

            referralTypeModels.add(new ReferralTypeModel(getString(R.string.tb_referral),
                    com.bluecodeltd.chimwemwe.chw.util.Constants.JSON_FORM.getTbReferralForm(), CoreConstants.TASKS_FOCUS.SUSPECTED_TB));

            referralTypeModels.add(new ReferralTypeModel(getString(R.string.gbv_referral),
                    com.bluecodeltd.chimwemwe.chw.util.Constants.JSON_FORM.getGbvReferralForm(), CoreConstants.TASKS_FOCUS.SUSPECTED_GBV));
        }
    ...
    public void startFormForEdit(Integer title_resource, String formName) {
        try {
            ...
            if (formName.equals(CoreConstants.JSON_FORM.getAncRegistration())) {
                ...
                String eventName = com.bluecodeltd.chimwemwe.chw.util.Utils.metadata().familyMemberRegister.updateEventType;
            ...
            startActivityForResult(com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getAncPncStartFormIntent(form, this), JsonFormUtils.REQUEST_CODE_GET_JSON);
        } catch (Exception e) {
            Timber.e(e);
        }
    }
