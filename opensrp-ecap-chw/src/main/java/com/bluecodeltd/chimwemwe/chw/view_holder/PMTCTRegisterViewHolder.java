...
public class PMTCTRegisterViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setUnsuppressedVlFlag(boolean flagged) {
        if (unsuppressedVlFlag != null) {
            ...
            try {
                if (flagged) {
                    android.view.animation.Animation anim = android.view.animation.AnimationUtils.loadAnimation(itemView.getContext(), com.bluecodeltd.chimwemwe.chw.R.anim.pulse);
    ...
    public void toggleUnsuppressedAlert() {
        ...
        if (vis != View.VISIBLE) {
            ...
            try {
                android.view.animation.Animation a = android.view.animation.AnimationUtils.loadAnimation(itemView.getContext(), com.bluecodeltd.chimwemwe.chw.R.anim.expand_in);
                unsuppressedAlert.startAnimation(a);
            } catch (Throwable ignored) {}
        } else {
            try {
                android.view.animation.Animation a = android.view.animation.AnimationUtils.loadAnimation(itemView.getContext(), com.bluecodeltd.chimwemwe.chw.R.anim.collapse_out);
