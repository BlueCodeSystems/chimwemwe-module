...
import com.bluecodeltd.chimwemwe.chw.dao.WashCheckDao;
...
public class WashCheckDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private com.bluecodeltd.chimwemwe.chw.databinding.FragmentWashCheckBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = com.bluecodeltd.chimwemwe.chw.databinding.FragmentWashCheckBinding.inflate(inflater, container, false);
