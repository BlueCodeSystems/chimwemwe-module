...
import com.bluecodeltd.chimwemwe.chw.contract.PncMemberProfileContract;
...
import com.bluecodeltd.chimwemwe.chw.interactor.ChildProfileInteractor;
import com.bluecodeltd.chimwemwe.chw.interactor.FamilyProfileInteractor;
import com.bluecodeltd.chimwemwe.chw.interactor.PncMemberProfileInteractor;
...
import com.bluecodeltd.chimwemwe.chw.presenter.PncMemberProfilePresenter;
...
import static com.bluecodeltd.chimwemwe.chw.util.Constants.EventType;
import static com.bluecodeltd.chimwemwe.chw.util.Constants.JSON_FORM;
import static com.bluecodeltd.chimwemwe.chw.util.Constants.ProfileActivityResults;
...
public class PncMemberProfileActivity extends CorePncMemberProfileActivity implements PncMemberProfileContract.View {
    ...
    private CommonPersonObjectClient clientObject() {
        CommonRepository commonRepository = com.bluecodeltd.chimwemwe.chw.util.Utils.context().commonrepository(com.bluecodeltd.chimwemwe.chw.util.Utils.metadata().familyMemberRegister.tableName);
    ...
    private void setEditViews(boolean enable, boolean within24Hours, Long longDate) {
        if (enable) {
            if (within24Hours) {
                ...
                textViewNotVisitMonth.setText(MessageFormat.format(getContext().getString(org.smartregister.pnc.R.string.pnc_visit_done), pncDay));
