...
import com.bluecodeltd.chimwemwe.chw.interactor.AncHomeVisitInteractor;
...
public class AncHomeVisitActivity extends BaseAncHomeVisitActivity {
    ...
    public void submittedAndClose() {
        ...
        com.bluecodeltd.chimwemwe.chw.util.Utils.startAsyncTask(new RunnableTask(runnable), null);
    ...
    public void startFormActivity(JSONObject jsonForm) {
        ...
        Form form = new Form();
        form.setActionBarBackground(com.bluecodeltd.chimwemwe.chw.R.color.family_actionbar);
