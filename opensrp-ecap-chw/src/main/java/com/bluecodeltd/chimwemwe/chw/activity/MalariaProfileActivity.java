...
import com.bluecodeltd.chimwemwe.chw.contract.MalariaProfileContract;
...
import com.bluecodeltd.chimwemwe.chw.custom_view.MalariaFloatingMenu;
import org.smartregister.chw.malaria.dao.MalariaDao;
import org.smartregister.chw.malaria.domain.MemberObject;
import org.smartregister.chw.malaria.presenter.BaseMalariaProfilePresenter;
import com.bluecodeltd.chimwemwe.chw.model.ReferralTypeModel;
import org.smartregister.chw.pnc.PncLibrary;
import com.bluecodeltd.chimwemwe.chw.presenter.FamilyOtherMemberActivityPresenter;
...
public class MalariaProfileActivity extends CoreMalariaProfileActivity implements MalariaProfileContract.View {
    ...
    public void startFormForEdit(Integer title_resource, String formName) {
        ...
        if (formName.equals(Constants.JSON_FORM.getFamilyMemberRegister())) {
            form = JsonFormUtils.getAutoPopulatedJsonEditMemberFormString(
            ...
            form = JsonFormUtils.getAutoJsonEditAncFormString(
