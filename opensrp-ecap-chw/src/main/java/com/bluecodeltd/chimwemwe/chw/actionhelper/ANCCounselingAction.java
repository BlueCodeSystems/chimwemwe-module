...
public class ANCCounselingAction implements BaseAncHomeVisitAction.AncHomeVisitActionHelper {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            JSONObject jsonObject = new JSONObject(jsonPayload);
            anc_counseling = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "anc_counseling");
            birth_hf_counseling = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "birth_hf_counseling");
            nutrition_counseling = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "nutrition_counseling");
