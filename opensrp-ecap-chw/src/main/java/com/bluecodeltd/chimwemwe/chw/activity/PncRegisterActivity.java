...
import com.bluecodeltd.chimwemwe.chw.fragment.PncRegisterFragment;
        ...
        if (resultCode == Activity.RESULT_OK) {
            try {
                ...
                if (CoreConstants.EventType.PREGNANCY_OUTCOME.equals(encounter_type)) {
                    ...
                    String pregnancyOutcome = org.smartregister.util.JsonFormUtils.getFieldJSONObject(fields, com.bluecodeltd.chimwemwe.chw.util.Constants.pregnancyOutcome).optString(JsonFormUtils.VALUE);
                    if (EnumUtils.isValidEnum(com.bluecodeltd.chimwemwe.chw.util.Constants.FamilyRegisterOptionsUtil.class, pregnancyOutcome)) {
