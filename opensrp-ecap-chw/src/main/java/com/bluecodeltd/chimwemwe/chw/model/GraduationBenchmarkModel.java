...
public class GraduationBenchmarkModel {
    String household_id, date_assessment,previous_asmt_date,hiv_status_enrolled,
            caregiver_hiv_status_enrolled,virally_suppressed,prevention,undernourished,
