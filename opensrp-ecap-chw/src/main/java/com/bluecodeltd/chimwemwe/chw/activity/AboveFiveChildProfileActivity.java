...
import com.bluecodeltd.chimwemwe.chw.custom_view.FamilyMemberFloatingMenu;
import com.bluecodeltd.chimwemwe.chw.model.ReferralTypeModel;
import com.bluecodeltd.chimwemwe.chw.presenter.AboveFiveChildProfilePresenter;
...
import static com.bluecodeltd.chimwemwe.chw.util.Constants.MALARIA_REFERRAL_FORM;
...
public class AboveFiveChildProfileActivity extends CoreAboveFiveChildProfileActivity implements CoreChildProfileContract.Flavor {
    ...
    private ChildProfileActivity.Flavor flavor = new com.bluecodeltd.chimwemwe.chw.activity.ChildProfileActivityFlv();
...
//                return true;
    ...
    private void openFamilyDueTab() {
        Intent intent = new Intent(this, com.bluecodeltd.chimwemwe.chw.activity.FamilyProfileActivity.class);
        ...
        intent.putExtra(com.bluecodeltd.chimwemwe.chw.util.Constants.INTENT_KEY.SERVICE_DUE, true);
