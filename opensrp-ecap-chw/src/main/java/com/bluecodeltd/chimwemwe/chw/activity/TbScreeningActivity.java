...
public class TbScreeningActivity extends AppCompatActivity {
    ...
    private com.bluecodeltd.chimwemwe.chw.adapter.TbScreeningAdapter screeningAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        screeningAdapter = new com.bluecodeltd.chimwemwe.chw.adapter.TbScreeningAdapter(
                this,
                new ArrayList<>(),
                new com.bluecodeltd.chimwemwe.chw.adapter.TbScreeningAdapter.Listener() {
                    @Override public void onAddOutcome(com.bluecodeltd.chimwemwe.chw.model.TbScreeningModel item) {
                        startTbOutcomeForm(item.getUnique_tb_id());
                    }
                    @Override public void onEdit(com.bluecodeltd.chimwemwe.chw.model.TbScreeningModel item) {
        ...
        try {
            ...
            try {
                if (uniqueTbId != null && !uniqueTbId.trim().isEmpty()) {
                    com.bluecodeltd.chimwemwe.chw.model.TbScreeningModel m = com.bluecodeltd.chimwemwe.chw.dao.TbScreeningDao.getByUniqueTbId(uniqueTbId);
                    if (m != null) {
