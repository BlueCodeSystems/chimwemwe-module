...
public class HealthFacilityVisitAction implements BaseAncHomeVisitAction.AncHomeVisitActionHelper {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            JSONObject jsonObject = new JSONObject(jsonPayload);
            anc_hf_visit = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit");
            anc_hf_visit_date = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit_date");
            weight = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "weight");
            sys_bp = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "sys_bp");
            dia_bp = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "dia_bp");
            hb_level = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "hb_level");
            ifa_received = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "ifa_received");
            tests_done = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getCheckBoxValue(jsonObject, "tests_done");
    ...
    public String postProcess(String s) {
        try {
            ...
            String value = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "anc_hf_visit");
