...
import com.bluecodeltd.chimwemwe.chw.fragment.HivTestingServiceRegisterFragment;
...
import com.bluecodeltd.chimwemwe.chw.presenter.HivTestingRegisterPresenter;
...
public class HivTestingServiceActivity extends BaseRegisterActivity implements IndexRegisterContract.View {
    ...
    protected void initializePresenter() {
        this.presenter = new HivTestingRegisterPresenter(this);
    }

    private IndexRegisterContract.Presenter indexRegisterPresenter(){
        return (HivTestingRegisterPresenter) this.presenter;
    }

    @Override
    protected BaseRegisterFragment getRegisterFragment() {
        return new HivTestingServiceRegisterFragment();
    }
...
//                    goToHouseholdProfile(hid);
    ...
    public void openForm(String formName, JSONObject jsonFormObject){
        ...
        try {
            formUtils = new FormUtils(HivTestingServiceActivity.this);
        } catch (Exception e) {
            e.printStackTrace();
        }
