...
import com.bluecodeltd.chimwemwe.chw.util.ChildUtils;
...
public class ChwMemberRegisterProvider extends FamilyMemberRegisterProvider {
    ...
    public void getView(Cursor cursor, SmartRegisterClient client, RegisterViewHolder viewHolder) {
        ...
        layoutParams.setMarginStart(context.getResources().getDimensionPixelSize(com.bluecodeltd.chimwemwe.chw.R.dimen.register_member_nav_margin));
