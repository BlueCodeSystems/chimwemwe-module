...
public class IdentificationRegisterInteractor implements IdentificationRegisterContract.Interactor {

    private final IdentificationRegisterContract.Presenter presenter;
    ...
    @Override
    public boolean saveRegistration(IdentificationEventClient identificaationEventClient, boolean isEditMode) {

        Runnable runnable = () -> {

            Event event = identificaationEventClient.getEvent();
            Client client = identificaationEventClient.getClient();
