...
import com.bluecodeltd.chimwemwe.chw.activity.HouseholdCasePlanActivity;
...
public class HouseholdCasePlanAdapter extends RecyclerView.Adapter<HouseholdCasePlanAdapter.ViewHolder>{
    ...
    public void startFormActivity(JSONObject jsonObject) {
        ...
        ((Activity) context).startActivityForResult(intent, com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.REQUEST_CODE_GET_JSON);
    }
