...
import com.bluecodeltd.chimwemwe.chw.model.FamilyProfileActivityModel;
import com.bluecodeltd.chimwemwe.chw.presenter.FamilyProfileActivityPresenter;
import com.bluecodeltd.chimwemwe.chw.provider.FamilyActivityRegisterProvider;
...
public class FamilyProfileActivityFragment extends BaseFamilyProfileActivityFragment {
    ...
    private void displayWashCheckHistory(CommonPersonObjectClient commonPersonObjectClient) {
        ...
        if (CoreConstants.EventType.WASH_CHECK.equalsIgnoreCase(type)) {
            ...
            formDetails.setEventType(com.bluecodeltd.chimwemwe.chw.util.Constants.EventType.ROUTINE_HOUSEHOLD_VISIT);
            formDetails.setFormName(com.bluecodeltd.chimwemwe.chw.util.Constants.JSON_FORM.getRoutineHouseholdVisit());
