...
public class HivTestingRegisterPresenter implements IndexRegisterContract.Presenter, IndexRegisterContract.InteractorCallBack {
    ...
    public HivTestingRegisterPresenter(IndexRegisterContract.View view) {
        this.view = view;
...
//            uniqueId = formJsonObject.getJSONObject("step1").getJSONArray("fields").getJSONObject(4).optString("value");
    ...
    public HivTestingServiceActivity getView() {
        if (activityWeakReference.get() != null) {
            return (HivTestingServiceActivity) view;
        }
        return null;
    }
