...
import com.bluecodeltd.chimwemwe.chw.actionhelper.DewormingAction;
import com.bluecodeltd.chimwemwe.chw.actionhelper.ECDAction;
import com.bluecodeltd.chimwemwe.chw.actionhelper.ExclusiveBreastFeedingAction;
import com.bluecodeltd.chimwemwe.chw.actionhelper.ImmunizationActionHelper;
import com.bluecodeltd.chimwemwe.chw.actionhelper.ImmunizationValidator;
import com.bluecodeltd.chimwemwe.chw.actionhelper.MNPAction;
import com.bluecodeltd.chimwemwe.chw.actionhelper.ObservationAction;
import com.bluecodeltd.chimwemwe.chw.actionhelper.VitaminaAction;
...
import com.bluecodeltd.chimwemwe.chw.fragment.BaseHomeVisitImmunizationFragmentFlv;
...
import static com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getBirthCertificateRegex;
...
public abstract class DefaultChildHomeVisitInteractorFlv implements CoreChildHomeVisitInteractor.Flavor {
    ...
    public JSONObject getFormJson(String name, String baseEntityID) throws Exception {
        return com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getJson(view.getContext(), name, baseEntityID);
    }
    ...
    private void setMinDate(JSONObject jsonObject, String dateFieldKey, String minDateString) {
        try {
            ...
            JSONObject fieldJSONObject = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getFieldJSONObject(com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.fields(jsonObject), dateFieldKey);
