...
import com.bluecodeltd.chimwemwe.chw.actionhelper.DangerSignsAction;
...
public abstract class DefaultPncHomeVisitInteractorFlv implements PncHomeVisitInteractor.Flavor {
    ...
    private class VaccineCardHelper extends HomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                ...
                vaccine_card = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "vaccine_card");
    ...
    private class UmbilicalCordHelper extends HomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                JSONObject jsonObject = new JSONObject(jsonPayload);
                cord_care = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "cord_care");
            } catch (JSONException e) {
                Timber.e(e);
            }
        }
    ...
    private class PNCHealthFacilityVisitHelper implements BaseAncHomeVisitAction.AncHomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                ...
                baby_weight = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "baby_weight");
                baby_temp = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "baby_temp");
    ...
    private class KangarooHelper extends HomeVisitActionHelper {
        ...
        public void onPayloadReceived(String jsonPayload) {
            try {
                JSONObject jsonObject = new JSONObject(jsonPayload);
                kangaroo = com.bluecodeltd.chimwemwe.chw.util.JsonFormUtils.getValue(jsonObject, "kangaroo");
            } catch (JSONException e) {
                Timber.e(e);
            }
        }
