...
public abstract class DefaultNavigationModelFlv implements NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        ...
        if (navigationOptions.size() == 0) {
            navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_families, R.mipmap.sidemenu_families_active, org.smartregister.chw.core.R.string.menu_all_families, Constants.DrawerMenu.ALL_FAMILIES, 0));
            ...
            navigationOptions.add(new NavigationOption(R.mipmap.sidemenu_children, R.mipmap.sidemenu_children_active, org.smartregister.chw.core.R.string.menu_child_clients, Constants.DrawerMenu.CHILD_CLIENTS, 0));
        }
