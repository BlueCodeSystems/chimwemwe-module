...
//        super.onNavigationItemSelected(item);
        ...
        if (item.getItemId() == com.bluecodeltd.chimwemwe.chw.R.id.action_family) {


        } else if (item.getItemId() == com.bluecodeltd.chimwemwe.chw.R.id.action_scan_qr) {
        ...
        } else if (item.getItemId() == com.bluecodeltd.chimwemwe.chw.R.id.action_register) {
