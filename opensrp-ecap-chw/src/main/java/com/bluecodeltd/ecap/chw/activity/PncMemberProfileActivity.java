...
import com.bluecodeltd.ecap.chw.contract.PncMemberProfileContract;
...
import com.bluecodeltd.ecap.chw.interactor.PncMemberProfileInteractor;
...
import com.bluecodeltd.ecap.chw.presenter.PncMemberProfilePresenter;
...
import static com.bluecodeltd.ecap.chw.util.Constants.EventType;
import static com.bluecodeltd.ecap.chw.util.Constants.JSON_FORM;
import static com.bluecodeltd.ecap.chw.util.Constants.ProfileActivityResults;
...
public class PncMemberProfileActivity extends CorePncMemberProfileActivity implements PncMemberProfileContract.View {
    ...
    private CommonPersonObjectClient clientObject() {
        CommonRepository commonRepository = com.bluecodeltd.ecap.chw.util.Utils.context().commonrepository(com.bluecodeltd.ecap.chw.util.Utils.metadata().familyMemberRegister.tableName);
